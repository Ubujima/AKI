...
Join our community on [Slack](https://git-scm.com/), [Discord](https://git-scm.com/) or [Google Doc](https://git-scm.com/) to stay updated and participate in discussions.
